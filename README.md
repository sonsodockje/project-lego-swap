...
Lego Market은 레고 애호가들을 위한 전용 거래 커뮤니티 웹사이트입니다. 직관적인 UI와 실시간 채팅 기능을 통해 사용자 간의 원활한 소통과 거래를 지원합니다.
...
2.  **Firebase 환경 변수 설정**
    ...
    - 프로젝트 루트 디렉터리에 `.env.local` 파일을 생성하고 아래와 같이 환경 변수를 추가합니다.
...
- [x] 게시물 댓글 기능: 각 게시물에 댓글을 작성하여 공개적으로 정보를 나눌 수 있는 기능을 도입합니다.
